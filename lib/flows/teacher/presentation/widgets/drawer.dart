...
import 'package:hackint/flows/teacher/presentation/pages/notifications/notifications.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              CustomMenuItem(
                ...
                onTap: () {
                  Routemaster.of(context).push(TeacherProfilePage.path);
                },
              ),
              const SizedBox(height: 16),
              CustomMenuItem(
